...
class DualSupervisedTrainer():
    ...
    def _get_loss(x, y, x_hat, y_hat, crits, x_lm=None, y_lm=None, lagrange=1e-3):
        ...
        if x_lm is not None and y_lm is not None:
            ...
            loss_x2y += lagrange * ((-lm_loss_y2x + -loss_x2y) - (-lm_loss_x2y + -loss_y2x.detach()))**2 #x2y 구하는거니까 y2x는 끊는다.
            loss_y2x += lagrange * ((-lm_loss_y2x + -loss_x2y.detach()) - (-lm_loss_x2y + -loss_y2x))**2 #y2x 구하는거니까 x2y는 끊는다.
        else:
            dual_loss = None
